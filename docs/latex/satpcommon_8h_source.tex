\doxysection{satpcommon.\+h}
\hypertarget{satpcommon_8h_source}{}\label{satpcommon_8h_source}\index{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/SATP/SATP/satpcommon.h@{C:/Users/stepp/Documents/Visual Studio 2022/Projects/C/SATP/SATP/satpcommon.h}}
...
\DoxyCodeLine{00039\ }
\DoxyCodeLine{00040\ \textcolor{preprocessor}{\#ifndef\ SATP\_COMMON\_H}}
\DoxyCodeLine{00041\ \textcolor{preprocessor}{\#define\ SATP\_COMMON\_H}}
\DoxyCodeLine{00042\ }
...
\DoxyCodeLine{00048\ \textcolor{preprocessor}{\#include\ "{}qsccommon.h"{}}}
\DoxyCodeLine{00049\ \textcolor{preprocessor}{\#include\ "{}intrinsics.h"{}}}
\DoxyCodeLine{00050\ }
\DoxyCodeLine{00057\ }
\DoxyCodeLine{00059\ }
\DoxyCodeLine{00064\ \textcolor{preprocessor}{\#if\ defined(\_DLL)}}
\DoxyCodeLine{00065\ \textcolor{preprocessor}{\#\ \ \ define\ SATP\_DLL\_API}}
\DoxyCodeLine{00066\ \textcolor{preprocessor}{\#endif}\textcolor{preprocessor}{}}
\DoxyCodeLine{00071\ \textcolor{preprocessor}{\#if\ defined(SATP\_DLL\_API)}}
\DoxyCodeLine{00072\ \textcolor{preprocessor}{\#\ \ \ if\ defined(QSC\_SYSTEM\_COMPILER\_MSC)}}
\DoxyCodeLine{00073\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ if\ defined(QSC\_DLL\_IMPORT)}}
\DoxyCodeLine{00074\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ \ \ \ \ define\ SATP\_EXPORT\_API\ \_\_declspec(dllimport)}}
\DoxyCodeLine{00075\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ else}}
\DoxyCodeLine{00076\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ \ \ \ \ define\ SATP\_EXPORT\_API\ \_\_declspec(dllexport)}}
...
\DoxyCodeLine{00079\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ if\ defined(QSC\_DLL\_IMPORT)}}
\DoxyCodeLine{00080\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ define\ SATP\_EXPORT\_API\ \_\_attribute\_\_((dllimport))}}
\DoxyCodeLine{00081\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ else}}
\DoxyCodeLine{00082\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ define\ SATP\_EXPORT\_API\ \_\_attribute\_\_((dllexport))}}
...
\DoxyCodeLine{00087\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ define\ SATP\_EXPORT\_API\ \_\_attribute\_\_\ (visibility(\_\_global))}}
\DoxyCodeLine{00088\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ \ \ \ \ else}}
\DoxyCodeLine{00089\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ define\ SATP\_EXPORT\_API\ \_\_attribute\_\_\ \_\_global}}
\DoxyCodeLine{00090\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ \ \ \ \ endif}}
\DoxyCodeLine{00091\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ elif\ defined(\_MSG\_VER)}}
\DoxyCodeLine{00092\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ \ \ \ \ define\ SATP\_EXPORT\_API\ extern\ \_\_declspec(dllexport)}}
\DoxyCodeLine{00093\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ else}}
\DoxyCodeLine{00094\ \textcolor{preprocessor}{\#\ \ \ \ \ \ \ \ \ \ \ define\ SATP\_EXPORT\_API\ \_\_attribute\_\_\ ((visibility\ ("{}default"{})))}}
...
\DoxyCodeLine{00098\ \textcolor{preprocessor}{\#\ \ \ define\ SATP\_EXPORT\_API}}
\DoxyCodeLine{00099\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00100\ }
\DoxyCodeLine{00101\ \textcolor{preprocessor}{\#if\ defined(DEBUG)\ ||\ defined(\_DEBUG)\ ||\ defined(\_\_DEBUG\_\_)\ ||\ (defined(\_\_GNUC\_\_)\ \&\&\ !defined(\_\_OPTIMIZE\_\_))}\textcolor{preprocessor}{}}
\DoxyCodeLine{00106\ \textcolor{preprocessor}{\#\ \ \ define\ SATP\_DEBUG\_MODE}}
\DoxyCodeLine{00107\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00108\ }
\DoxyCodeLine{00109\ \textcolor{preprocessor}{\#ifdef\ SATP\_DEBUG\_MODE}\textcolor{preprocessor}{}}
\DoxyCodeLine{00114\ \textcolor{preprocessor}{\#\ \ define\ SATP\_ASSERT(expr)\ assert(expr)}}
\DoxyCodeLine{00115\ \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{00116\ \textcolor{preprocessor}{\#\ \ define\ SATP\_ASSERT(expr)\ ((void)0)}}
